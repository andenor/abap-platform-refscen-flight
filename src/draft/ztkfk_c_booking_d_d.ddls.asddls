...
define view entity ZTKFK_C_Booking_D_D
  as projection on ZTKFK_I_Booking_D
{
  key BookingUUID,
      ...
      /* Associations */
      _BookingSupplement: redirected to composition child ZTKFK_C_BookingSupplement_D_D,
      _BookingStatus,
      _Carrier,
      _Connection,
      _Customer,
      _Travel: redirected to parent ZTKFK_C_Travel_D_D
}

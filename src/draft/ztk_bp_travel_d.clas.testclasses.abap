...
CLASS ltc_draft IMPLEMENTATION.
  ...
  METHOD class_setup.
    ...
    cds_test_environment = cl_cds_test_environment=>create( i_for_entity = 'ZTK_I_TRAVEL_D' ).
  ...
  METHOD settravelnumber_idempotence.
    ...
    " Fill in test data
    DATA travel_mock_data TYPE STANDARD TABLE OF ZTK_A_Travel_D.
    ...
    DATA reported TYPE RESPONSE FOR REPORTED LATE  ZTK_I_Travel_D.

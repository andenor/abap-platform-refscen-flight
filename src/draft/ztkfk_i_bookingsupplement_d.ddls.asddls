...
define view entity ZTKFK_I_BookingSupplement_D
  as select from ZTKFK_a_bksuppl_d

  association        to parent ZTKFK_I_Booking_D as _Booking        on $projection.BookingUUID  = _Booking.BookingUUID
  association [1..1] to ZTKFK_I_Travel_D         as _Travel         on $projection.TravelUUID   = _Travel.TravelUUID

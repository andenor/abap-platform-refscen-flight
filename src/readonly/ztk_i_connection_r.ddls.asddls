...
define view entity ZTK_I_Connection_R
  as select from ZTK_connection as Connection

  association [1..*] to ZTK_I_Flight_R as _Flight  on  $projection.AirlineID    = _Flight.AirlineID
...

{
  ...
  key   Connection.connection_id    as ConnectionID,
        ...
        @Consumption.valueHelpDefinition: [{  entity: {   name: 'ZTK_I_Airport',
                              element:    'AirportID' } }]
        @Search.defaultSearchElement: true

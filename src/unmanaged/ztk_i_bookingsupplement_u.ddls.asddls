...
define view entity ZTK_I_BookingSupplement_U
  as select from ZTK_book_suppl as BookingSupplement

  association        to parent ZTK_I_Booking_U as _Booking        on  $projection.TravelID  = _Booking.TravelID
                                                                   and $projection.BookingID = _Booking.BookingID
  association [1..1] to ZTK_I_Travel_U         as _Travel         on  $projection.TravelID  = _Travel.TravelID                                                                         

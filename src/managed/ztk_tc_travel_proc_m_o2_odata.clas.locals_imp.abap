...
PUBLIC SECTION.
  ...
  METHODS get_agency_data
            RETURNING VALUE(rs_agency) TYPE ZTK_agency.
  METHODS get_customer_data
            RETURNING VALUE(rs_customer) TYPE ZTK_customer.
  METHODS get_carrier_data
            RETURNING VALUE(rs_carrier) TYPE ZTK_carrier.

PRIVATE SECTION.
   class-data gt_agency TYPE STANDARD TABLE OF ZTK_agency.
   class-data gt_customer TYPE STANDARD TABLE OF ZTK_customer.
   class-data gt_carrier TYPE STANDARD TABLE OF ZTK_carrier.

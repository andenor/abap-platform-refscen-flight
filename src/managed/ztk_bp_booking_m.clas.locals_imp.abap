...
*  ENDMETHOD.
  ...
  METHOD earlynumbering_cba_booksupplem.
    DATA: max_booking_suppl_id TYPE ZTK_booking_supplement_id .
    ...
    LOOP AT entities ASSIGNING FIELD-SYMBOL(<booking_group>) GROUP BY <booking_group>-%tky.
      ...
      max_booking_suppl_id = REDUCE #( INIT max = CONV ZTK_booking_supplement_id( '0' )
                                       ...
                                       NEXT max = COND ZTK_booking_supplement_id( WHEN   booksuppl-target-booking_supplement_id > max
      ...
      max_booking_suppl_id = REDUCE #( INIT max = max_booking_suppl_id
                                       ...
                                       NEXT max = COND ZTK_booking_supplement_id( WHEN   target-booking_supplement_id > max

...
define view entity ZTK_C_BookSuppl_Processor_M
  as projection on ZTK_I_BookSuppl_M
{
  ...
  key booking_supplement_id       as BookingSupplementID,
      ...
      /* Associations */
      _Travel  : redirected to ZTK_C_Travel_Processor_M,
      _Booking : redirected to parent ZTK_C_Booking_Processor_M,
      _Product
}

...
define view entity ZTK_C_Booking_Processor_M
  as projection on ZTK_I_Booking_M
{
      @UI.facet: [ { id:            'Booking',
                     purpose:       #STANDARD,
  ...
  key booking_id         as BookingID,
      ...
      @Consumption.valueHelpDefinition: [ {entity: {name: 'ZTK_I_Flight', element: 'FlightDate' },
      ...
      /* Associations */
      _Travel         : redirected to parent ZTK_C_Travel_Processor_M,
      _BookSupplement : redirected to composition child ZTK_C_BookSuppl_Processor_M,
      _Customer,
      _Carrier,
      _BookingStatus

...
INTERFACE ZTKFK_if_flight_legacy
  PUBLIC.
...
******************************
  ...
  "! Table type of the table ZTKFK_TRAVEL
  TYPES tt_travel             TYPE ZTKFK_t_travel.
  "! Table type of the table ZTKFK_BOOKING
  TYPES tt_booking            TYPE ZTKFK_t_booking.
  "! Table type of the table ZTKFK_BOOK_SUPPL
  TYPES tt_booking_supplement TYPE ZTKFK_t_booking_supplement.
  "! Table type of the table ZTKFK_FLIGHT
  TYPES tt_flight             TYPE ZTKFK_t_flight.
...
******************
  ...
  TYPES ts_travel_key TYPE ZTKFK_s_travel_key.
  "! Table type that contains only the keys of Travel
  TYPES tt_travel_key TYPE ZTKFK_t_travel_key.

  "! Key structure of Booking
  TYPES ts_booking_key TYPE ZTKFK_s_booking_key.
  "! Table type that contains only the keys of Booking
  TYPES tt_booking_key TYPE ZTKFK_t_booking_key.

  "! Key structure of Booking Supplements
  TYPES ts_booking_supplement_key TYPE ZTKFK_s_booking_supplement_key.
  "! Table type that contains only the keys of Booking Supplements
  TYPES tt_booking_supplement_key TYPE ZTKFK_t_booking_supplement_key.



***********************************************************************************************************************************
* Flag structures for data components                                                                                             *
* IMPORTANT: When you add or remove fields from ZTKFK_TRAVEL, ZTKFK_BOOKING, ZTKFK_BOOK_SUPPL you need to change the following types *
***********************************************************************************************************************************
  ...
  TYPES ts_travel_intx TYPE ZTKFK_s_travel_intx.
    "! <strong>Flag structure for Booking data. </strong><br/>
    "! Each component identifies if the corresponding data has been changed.
    "! Where <em>abap_true</em> represents a change.
  TYPES ts_booking_intx TYPE ZTKFK_s_booking_intx.
    "! <strong>Flag structure for Booking Supplement data. </strong><br/>
    "! Each component identifies if the corresponding data has been changed.
    "! Where <em>abap_true</em> represents a change.
  TYPES ts_booking_supplement_intx TYPE ZTKFK_s_booking_supplement_intx.
...
**********************************************************************
  ...
  TYPES ts_travelx TYPE ZTKFK_s_travelx.
  TYPES tt_travelx TYPE ZTKFK_t_travelx.

  TYPES ts_bookingx TYPE ZTKFK_s_bookingx.
  TYPES tt_bookingx TYPE ZTKFK_t_bookingx.

  TYPES ts_booking_supplementx TYPE ZTKFK_s_booking_supplementx.
  TYPES tt_booking_supplementx TYPE ZTKFK_t_booking_supplementx.
...
*********
  ...
  TYPES:
    ...
    "! </ul>
    BEGIN OF ENUM action_code_enum STRUCTURE action_code BASE TYPE ZTKFK_action_code,
  ...
  TYPES:
    ...
    "! </ul>
    BEGIN OF ENUM travel_status_enum STRUCTURE travel_status BASE TYPE ZTKFK_travel_status,
      initial   VALUE IS INITIAL,
      new       VALUE 'N',
      planned   VALUE 'P',
      booked    VALUE 'B',
...
************************
  ...
  TYPES ts_travel_in TYPE ZTKFK_s_travel_in.
  ...
  TYPES ts_booking_in TYPE ZTKFK_s_booking_in.
  "! INcoming table type of the node Booking.  It contains the booking key and data fields.
  TYPES tt_booking_in TYPE ZTKFK_t_booking_in.
  ...
  TYPES ts_booking_supplement_in TYPE ZTKFK_s_booking_supplement_in.
  "! INcoming table type of the node Booking Supplement.  It contains the booking key, booking supplement key and data fields.
  TYPES tt_booking_supplement_in TYPE ZTKFK_t_booking_supplement_in.
...
*****************
  ...
  "! Table of messages
  TYPES tt_message TYPE ZTKFK_t_message.

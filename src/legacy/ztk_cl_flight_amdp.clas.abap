CLASS ZTK_cl_flight_amdp DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS convert_currency IMPORTING VALUE(iv_amount)               TYPE ZTK_total_price
                                                  VALUE(iv_currency_code_source) TYPE ZTK_currency_code
                                                  VALUE(iv_currency_code_target) TYPE ZTK_currency_code
                                                  VALUE(iv_exchange_rate_date)   TYPE d
                                        EXPORTING VALUE(ev_amount)               TYPE ZTK_total_price.
ENDCLASS.



CLASS ZTK_cl_flight_amdp IMPLEMENTATION.

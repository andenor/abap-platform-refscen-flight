CLASS ZTK_cx_flight_legacy DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS:
      gc_msgid TYPE symsgid VALUE 'ZTK_CM_FLIGHT_LEGAC',

      BEGIN OF agency_unkown,
        msgid TYPE symsgid VALUE 'ZTK_CM_FLIGHT_LEGAC',
    ...
    METHODS constructor
      IMPORTING
        ...
        booking_supplement_id TYPE ZTK_booking_supplement_id OPTIONAL
        agency_id             TYPE ZTK_agency_id OPTIONAL
        customer_id           TYPE ZTK_customer_id OPTIONAL
        carrier_id            TYPE ZTK_carrier-carrier_id OPTIONAL
        connection_id         TYPE ZTK_connection-connection_id OPTIONAL
        supplement_id         TYPE ZTK_supplement-supplement_id OPTIONAL
        begin_date            TYPE ZTK_begin_date OPTIONAL
        end_date              TYPE ZTK_end_date OPTIONAL
        booking_date          TYPE ZTK_booking_date OPTIONAL
        flight_date           TYPE ZTK_flight_date OPTIONAL
        status                TYPE ZTK_travel_status OPTIONAL
        currency_code         TYPE ZTK_currency_code OPTIONAL
        reamaining_travel     TYPE i OPTIONAL
        uname                 TYPE syuname OPTIONAL.


    DATA: mv_travel_id             TYPE ZTK_travel_id,
          mv_booking_id            TYPE ZTK_booking_id,
          mv_booking_supplement_id TYPE ZTK_booking_supplement_id,
          mv_agency_id             TYPE ZTK_agency_id,
          mv_customer_id           TYPE ZTK_customer_id,
          mv_carrier_id            TYPE ZTK_carrier-carrier_id,
          mv_connection_id         TYPE ZTK_connection-connection_id,
          mv_supplement_id         TYPE ZTK_supplement-supplement_id,
          mv_begin_date            TYPE ZTK_begin_date,
          mv_end_date              TYPE ZTK_end_date,
          mv_booking_date          TYPE ZTK_booking_date,
          mv_flight_date           TYPE ZTK_flight_date,
          mv_status                TYPE ZTK_travel_status,
          mv_currency_code         TYPE ZTK_currency_code,
...
CLASS ZTK_cx_flight_legacy IMPLEMENTATION.

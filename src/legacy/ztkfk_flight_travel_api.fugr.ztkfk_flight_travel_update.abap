...
*"----------------------------------------------------------------------
  ...
  ZTKFK_cl_flight_legacy=>get_instance( )->update_travel( EXPORTING is_travel              = is_travel

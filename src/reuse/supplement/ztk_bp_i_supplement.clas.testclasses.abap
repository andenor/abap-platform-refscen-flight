...
CLASS ltc_supplement DEFINITION FINAL FOR TESTING
  ...
  PRIVATE SECTION.
    ...
    DATA:
      mapped        TYPE RESPONSE FOR MAPPED   EARLY ZTK_i_supplement,
      failed        TYPE RESPONSE FOR FAILED   EARLY ZTK_i_supplement,
      reported      TYPE RESPONSE FOR REPORTED EARLY ZTK_i_supplement,
      failed_late   TYPE RESPONSE FOR FAILED   LATE  ZTK_i_supplement,
      reported_late TYPE RESPONSE FOR REPORTED LATE  ZTK_i_supplement.
...
CLASS ltc_supplement IMPLEMENTATION.
  ...
  METHOD class_setup.
    ...
    cds_test_environment = cl_cds_test_environment=>create( i_for_entity = 'ZTK_I_SUPPLEMENT' ).
  ENDMETHOD.
  ...
  METHOD validate_price_success.
    DATA:
      supplement  TYPE ZTK_supplement,
      supplements TYPE STANDARD TABLE OF ZTK_supplement.

    supplement = VALUE ZTK_supplement(
        supplement_id       = 'XX123'
  ...
  METHOD validate_price_failed.
    ...
    DATA:
      supplements     TYPE STANDARD TABLE OF ZTK_supplement WITH KEY supplement_id,
  ...
  METHOD earlynumbering_idempotency.
    DATA:
      entity          TYPE STRUCTURE FOR CREATE ZTK_i_supplement\\supplement,
  ...
  METHOD get_global_authorizations.
    DATA:
      requested_authorizations TYPE STRUCTURE FOR GLOBAL AUTHORIZATION REQUEST ZTK_i_supplement\\supplement,
      result                   TYPE STRUCTURE FOR GLOBAL AUTHORIZATION RESULT ZTK_i_supplement\\supplement,
      reported                 TYPE RESPONSE  FOR REPORTED EARLY ZTK_i_supplement.

...
define view entity ZTK_I_SupplementText
  as select from ZTK_suppl_text as SupplementText

  association        to parent ZTK_I_Supplement as _Supplement on $projection.SupplementID = _Supplement.SupplementID

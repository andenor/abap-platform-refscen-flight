...
define view entity ZTKFK_I_SupplementText
  as select from ZTKFK_suppl_text as SupplementText

  association        to parent ZTKFK_I_Supplement as _Supplement on $projection.SupplementID = _Supplement.SupplementID

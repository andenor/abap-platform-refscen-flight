CLASS ZTK_cx_supplement DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS:
      BEGIN OF price_required,
        msgid TYPE symsgid VALUE 'ZTK_CM_SUPPLEMENT',
    ...
    DATA:
      mv_supplement_category TYPE ZTK_supplement_category,
    ...
    METHODS:
      constructor
        IMPORTING
          ...
          supplement_category TYPE ZTK_supplement_category         OPTIONAL
...
CLASS ZTK_cx_supplement IMPLEMENTATION.

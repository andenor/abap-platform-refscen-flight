...
define root view entity ZTK_I_Supplement
  as select from ZTK_supplement as supplement

  composition [0..*] of ZTK_I_SupplementText        as _SupplementText
  association [0..1] to I_Currency                   as _Currency           on $projection.CurrencyCode = _Currency.Currency
  association [0..1] to ZTK_I_SupplementCategory_VH as _SupplementCategory on $projection.SupplementCategory = _SupplementCategory.SupplementCategory

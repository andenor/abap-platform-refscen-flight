...
CLASS lcl_test_double DEFINITION FOR TESTING.
  PUBLIC SECTION.
    ...
    CONSTANTS:
      supplement_entity_name TYPE abp_root_entity_name VALUE 'ZTK_I_SUPPLEMENT' ##NO_TEXT,
      text_entity_name       TYPE abp_root_entity_name VALUE 'ZTK_I_SUPPLEMENTTEXT' ##NO_TEXT,
      text_sub_name          TYPE abp_behv_changes-sub_name VALUE '_SUPPLEMENTTEXT' ##NO_TEXT.

    DATA:
      supplement_create TYPE TABLE FOR CREATE ZTK_I_Supplement\\Supplement,
      supplement_update TYPE TABLE FOR UPDATE ZTK_I_Supplement\\Supplement,
      text_create       TYPE TABLE FOR CREATE ZTK_I_Supplement\\Supplement\_SupplementText,
      text_update       TYPE TABLE FOR UPDATE ZTK_I_Supplement\\SupplementText,

      text_rba_link     TYPE TABLE FOR READ LINK   ZTK_I_Supplement\\Supplement\_SupplementText.
ENDCLASS.
...
CLASS lcl_test_double IMPLEMENTATION.
  ...
  METHOD if_abap_behavior_testdouble~read.
    TYPES:
      key         TYPE STRUCTURE FOR READ IMPORT ZTK_I_Supplement\\Supplement\_SupplementText.
...
CLASS ltcl_augmentation DEFINITION FINAL FOR TESTING
  ...
  PRIVATE SECTION.
    ...
    DATA:
      mapped   TYPE RESPONSE FOR MAPPED EARLY ZTK_c_supplement,
      failed   TYPE RESPONSE FOR FAILED EARLY ZTK_c_supplement,
      reported TYPE RESPONSE FOR REPORTED EARLY ZTK_c_supplement.
...
CLASS ltcl_augmentation IMPLEMENTATION.
  ...
  METHOD supplement_create.
    DATA:
      c_create TYPE STRUCTURE FOR CREATE ZTK_C_Supplement\\Supplement,
      i_create TYPE STRUCTURE FOR CREATE ZTK_I_Supplement\\Supplement.
    ...
    MODIFY ENTITIES OF ZTK_c_supplement
      ENTITY Supplement
  ...
  METHOD supplement_create_text_update.
    ...
    DATA:
      c_create TYPE STRUCTURE FOR CREATE ZTK_C_Supplement\\Supplement,
      i_create TYPE STRUCTURE FOR CREATE ZTK_I_Supplement\\Supplement,
      c_update TYPE STRUCTURE FOR UPDATE ZTK_C_Supplement\\Supplement,
      i_update TYPE STRUCTURE FOR UPDATE ZTK_I_Supplement\\Supplement.

CLASS ZTKFK_cm_flight_messages DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS:
      gc_msgid TYPE symsgid VALUE 'ZTKFK_CM_FLIGHT',

      BEGIN OF customer_unkown,
        msgid TYPE symsgid VALUE 'ZTKFK_CM_FLIGHT',
    ...
    DATA:
      ...
      mv_travel_id             TYPE ZTKFK_travel_id,
...
CLASS ZTKFK_cm_flight_messages IMPLEMENTATION.

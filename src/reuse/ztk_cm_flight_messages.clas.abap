CLASS ZTK_cm_flight_messages DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS:
      gc_msgid TYPE symsgid VALUE 'ZTK_CM_FLIGHT',

      BEGIN OF customer_unkown,
        msgid TYPE symsgid VALUE 'ZTK_CM_FLIGHT',
    ...
    DATA:
      ...
      mv_travel_id             TYPE ZTK_travel_id,
...
CLASS ZTK_cm_flight_messages IMPLEMENTATION.

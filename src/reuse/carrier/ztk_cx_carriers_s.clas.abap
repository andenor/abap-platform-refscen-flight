CLASS ZTK_cx_carriers_s DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS:
      BEGIN OF name_required,
        msgid TYPE symsgid VALUE 'ZTK_CM_CARRIER_S',
    ...
    DATA:
      mv_airline_id    TYPE ZTK_carrier_id,
    ...
    METHODS:
      constructor
        IMPORTING
          ...
          airline_id    TYPE ZTK_carrier_id         OPTIONAL
...
CLASS ZTK_cx_carriers_s IMPLEMENTATION.

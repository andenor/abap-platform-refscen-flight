...
define view entity ZTK_I_Flight
  as select from ZTK_flight as Flight

  association [1] to ZTK_I_Carrier as _Airline         on $projection.AirlineID = _Airline.AirlineID
  association [1] to ZTK_I_Connection as _Connection   on $projection.ConnectionID = _Connection.ConnectionID 
...

{
  ...
  key Flight.carrier_id     as AirlineID,
      ...
      @Consumption.valueHelpDefinition: [{ entity: { name: 'ZTK_I_Connection', element: 'ConnectionID'}, 
